...
class ModelInput(_message.Message):
    ...
    def __init__(self, requestId: _Optional[int] = ..., modelName: _Optional[str] = ..., layerName: _Optional[str] = ..., tensor: _Optional[_Union[_tensor_pb2.TensorProto, _Mapping]] = ...) -> None: ...
...
class ModelOutput(_message.Message):
    ...
    class ResultEntry(_message.Message):
        ...
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[_tensor_pb2.TensorProto, _Mapping]] = ...) -> None: ...
    HASVALUE_FIELD_NUMBER: _ClassVar[int]
    RESULT_FIELD_NUMBER: _ClassVar[int]
    hasValue: bool
    result: _containers.MessageMap[str, _tensor_pb2.TensorProto]
    def __init__(self, hasValue: bool = ..., result: _Optional[_Mapping[str, _tensor_pb2.TensorProto]] = ...) -> None: ...
