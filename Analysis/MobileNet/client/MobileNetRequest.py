...
class JsonRemoteDispatcher(Dispatcher):
    ...
    def dispatch(self, input: np.ndarray):
        ...
        response = requests.post(
            f"{tf_serving_url}/v1/models/mobile_net:predict", json=data
        )
...
class LocalDispatcher(Dispatcher):
    ...
    def __init__(self, part: str) -> None:
        super().__init__()
        interpreter = Interpreter("/models/mobile_net.tflite")
...
def main():
    ...
    remoteDispatchers = {"full": JsonRemoteDispatcher("full")}
