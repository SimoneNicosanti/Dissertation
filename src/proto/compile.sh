...
python -m grpc_tools.protoc -I./ --python_out=../FrontEnd/proto --pyi_out=../FrontEnd/proto --grpc_python_out=../FrontEnd/proto ./server.proto
...
python -m grpc_tools.protoc -I./ --python_out=../Optimizer/proto --pyi_out=../Optimizer/proto --grpc_python_out=../Optimizer/proto ./register.proto
