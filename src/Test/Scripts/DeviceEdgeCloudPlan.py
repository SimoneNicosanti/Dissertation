...
def build_file_name(
    ...
    return f"device_edge_cloud_plan_{case}.csv"
    ...
    add_df = pd.DataFrame(
        {
            ...
            "cloud_bandwidth": [cloud_bandwidth] * run_nums,
...
def main():
    ...
    os.makedirs("../Results/DeviceEdgeCloudPlan", exist_ok=True)
    ...
    parser.add_argument(
        "--cloud-bandwidth", help="Cloud Bandwidth", type=float, required=True
    )
