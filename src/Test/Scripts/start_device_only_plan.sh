...
############################## YOLO11x-seg ##############################
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.025 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.05 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.075 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.1 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.125 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.15 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.175 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.2 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
./start_test.sh FullTest.py --model-name yolo11x-seg --latency-weight 1.0 --energy-weight 0.0 --device-max-energy 0.0 --max-noises 0.5 --plan-gen-runs 1 --plan-deploy-runs 1 --plan-use-runs 25 --device-cpus $1
